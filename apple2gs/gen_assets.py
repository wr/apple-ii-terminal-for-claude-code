...
TUNES = [
    ...
    # Round 3 brief (Wells): a ditty — much faster, shorter loop, and no
    # long-held notes (those read as church hymn). Nothing over 1 beat.
    ("SKIP", 168,   # bouncy do-mi-sol skips, 4 bars
     [("C5",.5),("E5",.5),("G5",.5),("E5",.5),("C5",.5),("E5",.5),("G5",.5),("A5",.5),
      ("G5",.5),("E5",.5),("C5",.5),("E5",.5),("D5",1),("R",1),
      ("D5",.5),("F5",.5),("A5",.5),("F5",.5),("D5",.5),("F5",.5),("A5",.5),("B5",.5),
      ("A5",.5),("G5",.5),("E5",.5),("D5",.5),("C5",1),("R",1)],
     [("C3",1),("G2",1),("C3",1),("G2",1),("A2",1),("E2",1),("A2",1),("G2",1),
      ("F2",1),("C3",1),("F2",1),("G2",1),("C3",1),("G2",1),("C3",1),("R",1)]),
    ("HOPSCOTCH", 176,   # 2-bar micro-loop, in and out fast
     [("G4",.5),("C5",.5),("E5",.5),("G5",.5),("E5",.5),("C5",.5),("D5",.5),("R",.5),
      ("G4",.5),("B4",.5),("D5",.5),("G5",.5),("E5",.5),("C5",.5),("C5",.5),("R",.5)],
     [("C3",1),("G2",1),("C3",1),("G2",1),("G2",1),("D3",1),("C3",1),("R",1)]),
    ("TELETYPE", 160,   # staccato taps, a typing rhythm
    ...
    ("WHISTLE", 152,   # jaunty, like something whistled on a walk
     [("E5",.5),("G5",.5),("E5",.5),("C5",.5),("D5",.5),("E5",.5),("F5",.5),("D5",.5),
      ("E5",.5),("C5",.5),("A4",.5),("C5",.5),("G4",1),("R",1),
      ("A4",.5),("C5",.5),("E5",.5),("A5",.5),("G5",.5),("E5",.5),("D5",.5),("E5",.5),
      ("C5",.5),("D5",.5),("E5",.5),("G5",.5),("C5",1),("R",1)],
     [("C3",1),("G2",1),("A2",1),("G2",1),("F2",1),("G2",1),("C3",1),("R",1),
      ("A2",1),("E2",1),("F2",1),("G2",1),("C3",1),("G2",1),("C3",1),("R",1)]),
]
